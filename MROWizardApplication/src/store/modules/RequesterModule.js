...
const mutations = {
    completeState(state,requester){
        state.bAreYouPatient= requester.bAreYouPatient;
        state.bConfirmReport= requester.bConfirmReport;
        state.bDeadlineStatus= requester.bDeadlineStatus;
        state.bEmailVerified= requester.bEmailVerified;
        state.bForceCompliance= requester.bForceCompliance;
        state.bPatientNameChanged= requester.bPatientNameChanged;
        state.bPhoneNoVerified= requester.bPhoneNoVerified;
        state.bRTManualSelection= requester.bRTManualSelection;
        state.bRecordMostRecentVisit= requester.bRecordMostRecentVisit;
        state.bRequestAnotherRecord= requester.bRequestAnotherRecord;
        state.bRequestorFormSubmitted= requester.bRequestorFormSubmitted;
        state.bSpecifyVisit= requester.bSpecifyVisit;
        state.dtAuthExpire= requester.dtAuthExpire;
        state.dtDeadline= requester.dtDeadline;
        state.dtPatientDOB= requester.dtPatientDOB;
        state.dtRecordRangeEnd= requester.dtRecordRangeEnd;
        state.dtRecordRangeStart= requester.dtRecordRangeStart;
        state.nFacilityID= requester.nFacilityID;
        state.nFeedbackRating= requester.nFeedbackRating;
        state.nLocationID= requester.nLocationID;
        state.nRequesterID= requester.nRequesterID;
        state.sAddApartment= requester.sAddApartment;
        state.sAddCity= requester.sAddCity;
        state.sAddState= requester.sAddState;
        state.sAddStreetAddress= requester.sAddStreetAddress;
        state.sAddZipCode= requester.sAddZipCode;
        state.sAdditionalData= requester.sAdditionalData;
        state.sAuthSpecificEvent= requester.sAuthSpecificEvent;
        state.sFeedbackComment= requester.sFeedbackComment;
        state.sGUID= requester.sGUID;
        state.sIdentityIdName= requester.sIdentityIdName;
        state.sIdentityImage= '';
        state.sOtherRTText= requester.sOtherRTText;
        state.sPatientFirstName= requester.sPatientFirstName;
        state.sPatientLastName= requester.sPatientLastName;
        state.sPatientMiddleName= requester.sPatientMiddleName;
        state.sPatientPreviousFirstName= requester.sPatientPreviousFirstName;
        state.sPatientPreviousLastName= requester.sPatientPreviousLastName;
        state.sPatientPreviousMiddleName= requester.sPatientPreviousMiddleName;
        state.sPhoneNo= requester.sPhoneNo;
        state.sRecipientAddApartment= requester.sRecipientAddApartment;
        state.sRecipientAddCity= requester.sRecipientAddCity;
        state.sRecipientAddState= requester.sRecipientAddState;
        state.sRecipientAddStreetAddress= requester.sRecipientAddStreetAddress;
        state.sRecipientAddZipCode= requester.sRecipientAddZipCode;
        state.sRecipientFirstName= requester.sRecipientFirstName;
        state.sRecipientLastName= requester.sRecipientLastName;
        state.sRecipientOrganizationName= requester.sRecipientOrganizationName;
        state.sRelativeFileArray= requester.sRelativeFileArray;
        state.sRelativeFileNameArray= requester.sRelativeFileNameArray;
        state.sRelativeFirstName= requester.sRelativeFirstName;
        state.sRelativeLastName= requester.sRelativeLastName;
        state.sReleaseTo= requester.sReleaseTo;
        state.sReleaseToName= requester.sReleaseToName;
        state.sRequesterEmailId= requester.sRequesterEmailId;
        state.sSTAddApartment= requester.sSTAddApartment;
        state.sSTAddCity= requester.sSTAddCity;
        state.sSTAddState= requester.sSTAddState;
        state.sSTAddStreetAddress= requester.sSTAddStreetAddress;
        state.sSTAddZipCode= requester.sSTAddZipCode;
        state.sSTEmailAddress= requester.sSTEmailAddress;
        state.sSTFaxCompAdd= requester.sSTFaxCompAdd;
        state.sSTFaxNumber= requester.sSTFaxNumber;
        state.sSelectedLocation= requester.sSelectedLocation;
        state.sSelectedLocationName= requester.sSelectedLocationName;
        state.sSelectedPrimaryReasons= requester.sSelectedPrimaryReasons;
        state.sSelectedPrimaryReasonsName= requester.sSelectedPrimaryReasonsName;
        state.sSelectedRecordTypes= requester.sSelectedRecordTypes;
        state.sSelectedRelation= requester.sSelectedRelation;
        state.sSelectedRelationName= requester.sSelectedRelationName;
        state.sSelectedSensitiveInfo= requester.sSelectedSensitiveInfo;
        state.sSelectedShipmentTypes= requester.sSelectedShipmentTypes;
        state.sSelectedShipmentTypesName= requester.sSelectedShipmentTypesName;
        state.sSignatureData= requester.sSignatureData;
        state.sSpecifyVisitText= requester.sSpecifyVisitText;
        state.sWizardName= requester.sWizardName;
    },
