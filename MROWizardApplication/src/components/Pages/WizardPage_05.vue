<template>
  <div class="center">
    <div class="control-group">
      <h1>What is Patient's Full Name ?</h1>
    </div>
    <form>
        <v-row>
 ...
 name:"WizardPage_05",
    ...
    computed:{
      ...
      fNameError () {
        ...
        !this.$v.fname.maxLength && errors.push('First Name must be at most 15 characters long')        
      ...
      lNameError () {
        ...
        !this.$v.lname.maxLength && errors.push('Last Name must be at most 15 characters long')
      ...
      mInitialError () {
        ...
        !this.$v.minitial.maxLength && errors.push('Middle Initial must be at most 1 characters long')
  ...
  methods: {
    nextPage() {
      ...
      this.$store.commit("requestermodule/mutateisPatientDeceased",this.isPatientMinor);
      this.$store.commit("requestermodule/mutateisPatientDeceased",this.isPatientDeceased);
