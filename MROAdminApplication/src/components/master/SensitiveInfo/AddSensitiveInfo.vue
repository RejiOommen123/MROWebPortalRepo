<template>
  <div>
    <div id="AddSensitiveInfoPageBox">
      <form @submit.prevent="onSubmit" class="addSensitiveInfo-form">
        <v-row>
...
export default {
  ...
  methods: {
    onSubmit() {
      // API Call to add Sensitive Info
      this.dialogLoader = true;
      this.$http.post("Master/AddSensitiveInfo", this.sensitiveInfo).then(
        (response) => {
          if (response.ok == true) {
