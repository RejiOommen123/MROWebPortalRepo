  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "FTP Username", value: "sFTPUsername", width: "200px" },  
        { text: "FTP URL", value: "sFTPUrl", width: "200px" },  
      ...
      gridData: undefined,
       gridHeaders :{
        ...
        'ROI Location ID': 'nROILocationID',
