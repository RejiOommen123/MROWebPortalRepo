...
{
    public partial class addnewfieldsinloactiontbl : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    sUpdatedBy = table.Column<int>(nullable: false),
                    dtUpdatedDate = table.Column<DateTime>(nullable: false),
                    sLocationCode = table.Column<string>(nullable: true),
                    ...
                    sPhoneNo = table.Column<string>(nullable: true),
                    sFaxNo = table.Column<string>(nullable: true),
                    sConfigLogoName = table.Column<string>(nullable: true),
                    sConfigLogoData = table.Column<string>(nullable: true),
                    sConfigBackgroundName = table.Column<string>(nullable: true),
                    sConfigBackgroundData = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, new DateTime(2020, 6, 5, 17, 24, 36, 219, DateTimeKind.Local).AddTicks(2348), new DateTime(2020, 6, 5, 17, 24, 36, 220, DateTimeKind.Local).AddTicks(5069), "TestFields", "Test Wizards", 1, "Info about Cleveland", "Cleveland@101", "ftp://ftp.cleveland.com/", "Cleveland101", "Cleveland Clinic", "noreply@cleveland.com", "Cleveland@101", "smtp.cleveland.com", "Cleveland101", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5118), new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5142), 1, 1, "Continued Care", 1 },
                    { 4, 1, new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5250), new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5252), 4, 1, "Social Security Benifits/Claims", 1 },
                    { 5, 1, new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5255), new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5258), 5, 1, "OtherReason", 1 },
                    { 6, 1, new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5260), new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5262), 6, 1, "Continued Care", 1 },
                    { 3, 1, new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5245), new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5247), 3, 1, "Insurance", 1 },
                    { 2, 1, new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5238), new DateTime(2020, 6, 5, 17, 24, 36, 224, DateTimeKind.Local).AddTicks(5241), 2, 1, "Patient Request", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 5, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2339), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2342), 5, 1, "Laboratory Report", 1 },
                    { 1, 7, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2350), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2352), 7, 1, "Other", 1 },
                    { 1, 3, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2328), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2330), 3, 1, "Operative Reports", 1 },
                    { 1, 2, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2322), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2325), 2, 1, "Discharge Summary", 1 },
                    { 1, 1, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2225), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2243), 1, 1, "Abstract", 1 },
                    { 1, 6, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2345), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2347), 6, 1, "Radiology Report", 1 },
                    { 1, 4, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2334), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(2336), 4, 1, "History and Physical", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(8654), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(8670), 1, 1, "HIV Test Results", 1 },
                    { 1, 2, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(8739), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(8742), 2, 1, "Behavioural/Mental Health Records", 1 },
                    { 1, 3, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(8746), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(8748), 3, 1, "Substance Abuse Information", 1 },
                    { 1, 4, new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(8752), new DateTime(2020, 6, 5, 17, 24, 36, 225, DateTimeKind.Local).AddTicks(8754), 4, 1, "Sexually Transmitted Dieases", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2020, 6, 5, 17, 24, 36, 226, DateTimeKind.Local).AddTicks(4878), new DateTime(2020, 6, 5, 17, 24, 36, 226, DateTimeKind.Local).AddTicks(4892), 1, 1, 1, "Patient Portal" },
                    { 2, 1, new DateTime(2020, 6, 5, 17, 24, 36, 226, DateTimeKind.Local).AddTicks(4965), new DateTime(2020, 6, 5, 17, 24, 36, 226, DateTimeKind.Local).AddTicks(4967), 2, 1, 1, "Secure Email" },
                    { 4, 1, new DateTime(2020, 6, 5, 17, 24, 36, 226, DateTimeKind.Local).AddTicks(5007), new DateTime(2020, 6, 5, 17, 24, 36, 226, DateTimeKind.Local).AddTicks(5009), 4, 1, 1, "In-Person" },
                    { 3, 1, new DateTime(2020, 6, 5, 17, 24, 36, 226, DateTimeKind.Local).AddTicks(4971), new DateTime(2020, 6, 5, 17, 24, 36, 226, DateTimeKind.Local).AddTicks(4973), 3, 1, 1, "Email" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 17, 14, "Authorization Expire", "AuthExpire" },
                    { 2, 3, "Are you Patient", "AreyouPatient" },
                    { 3, 4, "Patient Email Id", "PEmailId" },
                    { 4, 4, "Confirm Report", "ConfirmReport" },
                    { 5, 5, "Patient First Name", "PFName" },
                    { 6, 5, "Patient Middle Initial", "PMInitial" },
                    { 7, 5, "Patient Last Name", "PLName" },
                    { 8, 5, "Is Patient Deceased", "IsPatientDeceased" },
                    { 9, 6, "Zip Code", "ZipCode" },
                    { 11, 8, "Patient Birth Date", "PBirthDate" },
                    { 12, 9, "Primary Reason", "PrimaryReason" },
                    { 13, 10, "TimeFrame Date Range", "TFDateRange" },
                    { 14, 11, "Record Type", "RecordType" },
                    { 15, 12, "Sensitive Info", "SensitiveInfo" },
                    { 16, 13, "Authorization Expire", "AuthExpire" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7607), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7663), 1, 1, 1 },
                    { 1, 2, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7746), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7749), 2, 1, 1 },
                    { 1, 3, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7773), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7775), 3, 1, 1 },
                    { 1, 4, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7781), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7783), 4, 1, 1 },
                    { 1, 5, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7786), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7788), 5, 1, 1 },
                    { 1, 6, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7791), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7793), 6, 1, 1 },
                    { 1, 7, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7796), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7798), 7, 1, 1 },
                    { 1, 8, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7801), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7803), 8, 1, 1 },
                    { 1, 9, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7806), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7808), 9, 1, 1 },
                    { 1, 10, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7811), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7813), 10, 1, 1 },
                    { 1, 11, true, new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7816), new DateTime(2020, 6, 5, 17, 24, 36, 223, DateTimeKind.Local).AddTicks(7819), 11, 1, 1 }
                });
